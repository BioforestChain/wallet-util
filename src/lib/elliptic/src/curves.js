...
export function PresetCurve(options) {
...
function defineCurve(options) {
  let curve;
  return () => {
    return (curve ??= new PresetCurve(options));
  };
}

export const p192 = defineCurve({
  type: 'short',
  prime: 'p192',
...
export const curve25519 = defineCurve({
  type: 'mont',
  prime: 'p25519',
...
export const ed25519 = defineCurve({
  type: 'edwards',
  prime: 'p25519',
  p: '7fffffffffffffff ffffffffffffffff ffffffffffffffff ffffffffffffffed',
  a: '-1',
...
export const secp256k1 = defineCurve({
  type: 'short',
  prime: 'k256',
