...
declare type BcryptReturnType<T> = T extends IBcryptOptionsBinary
  ? Uint8Array
  : string;
/**
 ...
 */
export declare function bcrypt<T extends BcryptOptions>(
  options: T
 ...
 */
export declare function bcryptVerify(
