...
import { $Exports } from './wasm_loader.mjs';
...
let wasm: $Exports;
let WASM_BUFFER: Uint8Array;
let WASM_PRIVATE_KEY_PTR: number;
let WASM_PUBLIC_KEY_INPUT_PTR: number;
let WASM_PUBLIC_KEY_INPUT_PTR2: number;
let WASM_X_ONLY_PUBLIC_KEY_INPUT_PTR: number;
let WASM_X_ONLY_PUBLIC_KEY_INPUT2_PTR: number;
let WASM_TWEAK_INPUT_PTR: number;
let WASM_HASH_INPUT_PTR: number;
let WASM_EXTRA_DATA_INPUT_PTR: number;
let WASM_SIGNATURE_INPUT_PTR: number;
let PRIVATE_KEY_INPUT: Uint8Array;
let PUBLIC_KEY_INPUT: Uint8Array;
let PUBLIC_KEY_INPUT2: Uint8Array;
let X_ONLY_PUBLIC_KEY_INPUT: Uint8Array;
let X_ONLY_PUBLIC_KEY_INPUT2: Uint8Array;
let TWEAK_INPUT: Uint8Array;
let HASH_INPUT: Uint8Array;
let EXTRA_DATA_INPUT: Uint8Array;
let SIGNATURE_INPUT: Uint8Array;

export const init = cacheCall((wasmExports: $Exports) => {
  wasm = wasmExports;
