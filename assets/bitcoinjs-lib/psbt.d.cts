...
import { Psbt as PsbtBase } from '../bip174/index.cjs';
import {
  KeyValue,
  PsbtGlobalUpdate,
  PsbtInput,
  ...
  PsbtOutput,
  PsbtOutputUpdate,
} from '../bip174/src/lib/interfaces.cjs';
...
export declare type ValidateSigFunction = (
  pubkey: Buffer,
  msghash: Buffer,
  signature: Buffer
) => boolean;
...
declare type PsbtOutputExtended =
