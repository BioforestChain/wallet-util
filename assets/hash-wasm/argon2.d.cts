...
declare type Argon2ReturnType<T> = T extends IArgon2OptionsBinary
  ? Uint8Array
  : string;
/**
 ...
 */
export declare function argon2i<T extends IArgon2Options>(
  options: T
 ...
 * @returns Computed hash
 */
export declare function argon2id<T extends IArgon2Options>(
  options: T
): Promise<Argon2ReturnType<T>>;
/**
 ...
 * @returns Computed hash
 */
export declare function argon2d<T extends IArgon2Options>(
  options: T
): Promise<Argon2ReturnType<T>>;
